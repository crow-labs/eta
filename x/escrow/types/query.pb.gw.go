...
func request_Query_Crow_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	protoReq.CrowId, err = runtime.Uint64(val)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "eta", "escrow", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Crow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"crow-labs", "eta", "escrow", "crow", "crowId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CrowAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "eta", "escrow", "crow"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Dispute_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"crow-labs", "eta", "escrow", "dispute", "disputeId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DisputeAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "eta", "escrow", "dispute"}, "", runtime.AssumeColonVerbOpt(true)))
)
