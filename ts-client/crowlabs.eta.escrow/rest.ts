...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/crow-labs/eta/escrow/crow
   */
  queryCrowAll = (
    query?: {
    ...
    this.request<EscrowQueryAllCrowResponse, RpcStatus>({
      path: `/crow-labs/eta/escrow/crow`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/crow-labs/eta/escrow/crow/{crowId}
   */
   ...
   * @request GET:/crow-labs/eta/escrow/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<EscrowQueryParamsResponse, RpcStatus>({
      path: `/crow-labs/eta/escrow/params`,
      method: "GET",
      format: "json",
      ...params,
    });
