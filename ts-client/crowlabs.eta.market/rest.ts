...
/**
 * @title eta/market/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/crow-labs/eta/market/item
   */
  queryItemAll = (
    query?: {
    ...
    this.request<MarketQueryAllItemResponse, RpcStatus>({
      path: `/crow-labs/eta/market/item`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/crow-labs/eta/market/item/{itemId}
   */
   ...
   * @request GET:/crow-labs/eta/market/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<MarketQueryParamsResponse, RpcStatus>({
      path: `/crow-labs/eta/market/params`,
      method: "GET",
      format: "json",
      ...params,
    });
