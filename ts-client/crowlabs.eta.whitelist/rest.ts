...
/**
 * @title eta/whitelist/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/crow-labs/eta/whitelist/member
   */
  queryMemberAll = (
    query?: {
    ...
    this.request<WhitelistQueryAllMemberResponse, RpcStatus>({
      path: `/crow-labs/eta/whitelist/member`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/crow-labs/eta/whitelist/member/{addresss}
   */
  queryMember = (addresss: string, params: RequestParams = {}) =>
    this.request<WhitelistQueryGetMemberResponse, RpcStatus>({
      path: `/crow-labs/eta/whitelist/member/${addresss}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/crow-labs/eta/whitelist/params
   */
