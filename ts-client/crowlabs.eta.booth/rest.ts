...
export interface BoothGuiltyVote {
  /** @format uint64 */
  voteId?: string;
 ...
 */
export interface BoothQueryParamsResponse {
  /** Params defines the parameters for the module. */
  params?: BoothParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryGuiltyVoteAll
   * @summary Queries a list of GuiltyVote items.
   * @request GET:/crow-labs/eta/booth/guilty_vote
   */
  queryGuiltyVoteAll = (
    query?: {
    ...
    this.request<BoothQueryAllGuiltyVoteResponse, RpcStatus>({
      path: `/crow-labs/eta/booth/guilty_vote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryGuiltyVote
   * @summary Queries a GuiltyVote by index.
   * @request GET:/crow-labs/eta/booth/guilty_vote/{voteId}
   */
  queryGuiltyVote = (voteId: string, params: RequestParams = {}) =>
    this.request<BoothQueryGetGuiltyVoteResponse, RpcStatus>({
      path: `/crow-labs/eta/booth/guilty_vote/${voteId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/crow-labs/eta/booth/params
   */
